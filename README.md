...
Existing approaches to Hamilton automation tend to make decisions on your behalf: they hide parameters, infer behavior, or impose workflow structure. That is fine but it becomes hard to use as a foundation. So py-hamilton-steps performs not extra abstraction, it is a 1 to 1 translation to expose venus steps in a python API.
